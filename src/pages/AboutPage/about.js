    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-24 bg-primary/5 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <span className="text-secondary font-semibold font-body tracking-widest uppercase text-sm mb-3 block">Since 1991</span>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="w-full md:w-1/2 text-center md:text-left">
              ...
              <div className="space-y-6 text-gray-600 font-body text-lg leading-relaxed relative">
                 <p>
                   <strong>Er. Bhavesh Agrawal</strong> established Shubham Developers with a singular mission: to bring world-class construction standards to the heart of Shirley. As a Civil Engineer, his approach goes beyond mere aesthetics; it is rooted in structural integrity and functional design.
                 </p>
                 <p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center p-6 bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              <div className="text-5xl font-bold mb-2 bg-gradient-to-r from-primary to-primary/80 bg-clip-text text-transparent font-heading">43+</div>
              <div className="text-gray-600 font-body font-medium">Total Projects</div>
            </div>
            <div className="text-center p-6 bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              <div className="text-5xl font-bold mb-2 bg-gradient-to-r from-secondary to-accent bg-clip-text text-transparent font-heading">2500+</div>
              <div className="text-gray-600 font-body font-medium">Happy Customers</div>
            </div>
            <div className="text-center p-6 bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              <div className="text-5xl font-bold mb-2 bg-gradient-to-r from-primary to-primary/80 bg-clip-text text-transparent font-heading">3300+</div>
              <div className="text-gray-600 font-body font-medium">Total Units</div>
            </div>
            <div className="text-center p-6 bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              <div className="text-5xl font-bold mb-2 bg-gradient-to-r from-secondary to-accent bg-clip-text text-transparent font-heading">35L+</div>
