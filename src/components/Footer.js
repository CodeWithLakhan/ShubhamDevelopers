    ...
    <footer className="bg-blue-50 text-gray-800">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-2xl font-bold mb-4 text-blue-600">Shubham Developers</h3>
            <p className="text-gray-600 mb-4">
              Gujarat's one of the greatest emerging real estate developers with signature projects 
              especially in the cities of Ahmedabad, Vapi & Umbergaon.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-xl font-semibold mb-4 text-blue-600">Quick Links</h4>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-xl font-semibold mb-4 text-blue-600">Contact Us</h4>
            <div className="space-y-3 text-gray-600">
              ...
              <p>
                <a href="tel:+919099541414" className="hover:text-blue-600 transition">
                  +91 90995 41414
                </a>
              </p>
            </div>
